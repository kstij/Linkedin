...
export default function Redeem() {
  ...
  const handleDownload = () => {
    if (claimLink) {
      ...
      a.href = url;
      a.download = 'linkedin-premium-link.txt';
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-200 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="appearance-none block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-gray-900 sm:text-sm"
            ...
            {claimLink && (
              <div className="rounded-lg bg-green-50 p-4 border border-green-100 flex flex-col items-center">
